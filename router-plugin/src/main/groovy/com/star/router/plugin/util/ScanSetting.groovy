...
class ScanSetting {
     ...
     */
    static final String GENERATE_TO_CLASS_NAME = 'com/star/router/core/LogisticsCenter'
    /**
     ...
     */
    static final String ROUTER_CLASS_PACKAGE_NAME = 'com/star/router/routes/'
    /**
     * The package name of the interfaces
     */
    private static final INTERFACE_PACKAGE_NAME = 'com/star/router/base/'
