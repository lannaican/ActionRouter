...
class ScanSetting {
     ...
     */
    static final String GENERATE_TO_CLASS_NAME = 'com/baby/jojo/router/core/LogisticsCenter'
    /**
     ...
     */
    static final String GENERATE_TO_METHOD_NAME = 'loadRoutes'
    /**
     * The package name of the class generated by the annotationProcessor
     */
    static final String ROUTER_CLASS_PACKAGE_NAME = 'com/baby/jojo/router/routes/'
    /**
     * The package name of the interfaces
     */
    private static final INTERFACE_PACKAGE_NAME = 'com/baby/jojo/router/base/'
